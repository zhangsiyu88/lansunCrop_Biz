...
public class Inquiry extends Result {
	...
	public String toString() {
		return "Inquiry [againInquiryTimeSec=" + againInquiryTimeSec
				+ ", appearanceColor=" + appearanceColor + ", attNum=" + attNum
				+ ", bid1=" + bid1 + ", bid2=" + bid2 + ", bid3=" + bid3
				+ ", bid4=" + bid4 + ", bid5=" + bid5 + ", bid6=" + bid6
				+ ", biddingNum=" + biddingNum + ", biddingTime=" + biddingTime
				+ ", carseriesId=" + carseriesId + ", carseriesImgUrl="
				+ carseriesImgUrl + ", carseriesName=" + carseriesName
				+ ", city=" + city + ", consuId=" + consuId + ", dealershipId="
				+ dealershipId + ", dealershipNum=" + dealershipNum
				+ ", discount=" + discount + ", finalOffer=" + finalOffer
				+ ", grabNum=" + grabNum + ", id=" + id + ", imgUrl=" + imgUrl
				+ ", inquiryInvalidTime=" + inquiryInvalidTime
				+ ", inquiryTime=" + inquiryTime + ", inquiryTimeSec="
				+ inquiryTimeSec + ", intentionTime=" + intentionTime
				+ ", maxDiscount=" + maxDiscount + ", maxRecordId="
				+ maxRecordId + ", minOffer=" + minOffer + ", modelsId="
				+ modelsId + ", modelsName=" + modelsName + ", msrp=" + msrp
				+ ", name=" + name + ", newBiddingNum=" + newBiddingNum
				+ ", newOffer=" + newOffer + ", nickname=" + nickname
				+ ", paymentModel=" + paymentModel + ", phoneNum=" + phoneNum
				+ ", preferentialInfo=" + preferentialInfo + ", pushTime="
				+ pushTime + ", sex=" + sex + ", status=" + status
				+ ", userId=" + userId + ", userNum=" + userNum + ", year="
				+ year + "]";
	}
