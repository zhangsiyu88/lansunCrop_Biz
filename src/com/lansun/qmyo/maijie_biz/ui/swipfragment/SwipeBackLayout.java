...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link swipebackfragment.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link swipebackfragment.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
...
//      ViewGroup decorChild = (ViewGroup) decor.getChildAt(0);
        ViewGroup decorChild = (ViewGroup) decor.getChildAt(0);//针对ReleaseActWriteInfoFragment的页面需要getChildAt(0)
        decor.removeView(decorChild);
        addView(decorChild);//将decorChild 送入到  SwipeBackLayout 中作为子级的View
        setContentView(decorChild);//将原本的fragment中的主view 作为  SwipeBackLayout 的主内容
        decor.addView(this);
    	
//			View decor = fragment.getView();
//			ViewParent parent = decor.getParent();
//			((ViewGroup)parent).removeView(decor);
//			this.addView(decor);
//			this.setContentView(decor);
