...
import com.lansun.qmyo.maijie_biz.utils.GeometryUtil;
import com.lansun.qmyo.maijie_biz.utils.Utils;

/**
 * This view should be added to WindowManager, so we can drag it to anywhere.
 * 圆按钮是被加载到window上的，所以它可以被拖拽到任意一个地方
 * @author PoplarTang
 *
 */
