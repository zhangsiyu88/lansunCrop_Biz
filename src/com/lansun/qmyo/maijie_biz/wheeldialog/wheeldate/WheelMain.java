...
public class WheelMain {
	...
	public WheelMain(View view) {
		super();
		this.view = view;
		//在这里将hasSelectTime设置为true才有机会看到时分，哈哈哈哈哈哈哈哈，真是人才啊！
		hasSelectTime = true;
		setView(view);
	}
	...
	//写一个对外的方法，能够将年月日时分以纯数字的形式传出去
	public int[]  getPureCodeTime() {
		
		int[] pureCodeTime = new int[]{wv_year.getCurrentItem() + START_YEAR,
